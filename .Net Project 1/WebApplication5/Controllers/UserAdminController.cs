...
namespace WebApplication5.Controllers
{
    ...
    public class UserAdminController : Controller
    {
        ...
        public async Task<ActionResult> Details(string id)
        {
            ...
            ViewBag.RolesNames = await UserManager.GetRolesAsync(user.Id);
        ...
        public async Task<ActionResult> Edit([Bind(Include = "Id,Email")] EditUserViewModel editUser, params string[] selectedRole)
        {
            if (ModelState.IsValid)
            {
                ...
                result = await UserManager.RemoveFromRolesAsync(user.Id, selectedRole.Except(userRoles).ToArray<string>());
